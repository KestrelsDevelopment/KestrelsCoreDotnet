...
public static class ServiceCollectionExtensions
{
    ...
    extension(IServiceCollection services)
    {
        ...
        public IServiceCollection AddHostedSingleton<TService>(Func<IServiceProvider, TService> factory)
        ...
        /// <typeparam name="TService">The type of the service to register. Must implement <see cref="IHostedService"/>.</typeparam>
        /// <returns>The <see cref="IServiceCollection"/> with the singleton and hosted service registered.</returns>
        public IServiceCollection AddHostedSingleton<TService>() where TService : class, IHostedService
        {
        ...
        /// <returns>The <see cref="IServiceCollection"/> with the singleton and hosted service registered.</returns>
        public IServiceCollection AddHostedSingleton<TService>(TService instance) where TService : class, IHostedService
        {
        ...
        /// <returns>The <see cref="IServiceCollection"/> with the singleton and hosted service registered.</returns>
        public IServiceCollection AddHostedSingleton<TService, TImpl>(Func<IServiceProvider, TImpl> factory)
            where TService : class, IHostedService where TImpl : class, TService
        {
            services.AddSingleton(factory);
            services.AddHostedService(p => p.GetRequiredService<TService>());
        ...
        /// <returns>The <see cref="IServiceCollection"/> with the singleton and hosted service registered.</returns>
        public IServiceCollection AddHostedSingleton<TService, TImpl>() where TService : class, IHostedService
        ...
        /// <returns>The <see cref="IServiceCollection"/> with the singleton and hosted service registered.</returns>
        public IServiceCollection AddHostedSingleton<TService, TImpl>(TImpl instance)
            where TService : class, IHostedService where TImpl : class, TService
        {
            services.AddSingleton(instance);
            services.AddHostedService(p => p.GetRequiredService<TService>());
